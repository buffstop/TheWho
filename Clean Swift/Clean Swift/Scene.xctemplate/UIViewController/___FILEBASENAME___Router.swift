...
protocol ___FILEBASENAMEASIDENTIFIER___DataTransferInterfaceRouter:class {
    //define Presenters input interface here
}

protocol ___FILEBASENAMEASIDENTIFIER___RouterDataSource:class {
    // get data to pass to next ViewController
}
...
class ___FILEBASENAMEASIDENTIFIER___Router: ___FILEBASENAMEASIDENTIFIER___DataTransferInterfaceRouter {
